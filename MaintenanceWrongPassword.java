...
public class MaintenanceWrongPassword {
	@Test public void login() throws IOException, InterruptedException {
		...
		FileInputStream ip= new FileInputStream("C:\\Users\\shubh\\eclipse-workspace\\Exclerselenium\\src\\test\\java\\project\\maintainancewrongpass");
		 prop.load(ip);
	       ...
	       sendKeys(prop.getProperty("passkey"));
